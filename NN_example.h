...
double training_data[][INPUT_SIZE] = {{1.736111111},{1.757195665},{1.778280218},{1.799364772},{1.820449325},{1.841533879},{1.862618432},{1.883702986},{1.904787539},{1.925872093},{1.946956647},
	...
	double test_data[][INPUT_SIZE] = {	
		{1.738352154},	{1.843936529},	{1.948227644},	{2.045393705},	{2.145127026},	{2.254323512},	{2.371944258},	
		{2.465137258},	{2.573150767},	{2.691392192},	{2.787933546},	{2.889562126},	{2.988157249},	{3.093709396},	
		{3.197413563},	{3.310724356},	{3.414134243},	{3.536591687},	{3.633737892}    
	};
...
void initialize() {
    for (int i = 0; i < INPUT_SIZE; i++) {
        weights[i] = (1 / 1) * 2 - 1; // initialize the weight randomly
    }
    bias = (1 / 1) * 2 - 1; // initialize the bias randomly
}
